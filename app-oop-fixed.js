        ...
        searchInput.addEventListener('input', (e) => {
            ...
            if (query.length >= 2) {
                this.searchTimeout = setTimeout(() => {
                    console.log('🔍 About to perform search for:', query);
...
class SocialMediaApp {
    ...
    async initializeMainApp() {
        try {
            ...
            console.log('  - window.Search.performSearch(query)');
...
window.testUsers = () => {
    ...
    Search.searchUsers('john').then(users => console.log('Users found:', users));
};

window.testPosts = () => {
    console.log('📝 Testing posts search...');
    Search.searchPosts('test').then(posts => console.log('Posts found:', posts));
};
...
console.log('  - window.app.UI.renderComments(postId, container)');
console.log('  - window.Search.performSearch(query)');
console.log('  - window.testSearch(query) - Test search function');
console.log('  - window.testUsers() - Test users search');
console.log('  - window.testPosts() - Test posts search');
console.log('  - window.restartApp() - Restart application');
